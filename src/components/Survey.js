...
const Survey = () => {
  ...
  const updateQuestion = useCallback(
    (index, field, value, survey = newSurvey) => {
  ...
  const addOption = useCallback(
    (questionIndex, survey = newSurvey) => {
      const updatedQuestions = [...survey.questions];
  ...
  const updateOption = useCallback(
    (questionIndex, optionIndex, value, survey = newSurvey) => {
      const updatedQuestions = [...survey.questions];
  ...
  const removeOption = useCallback(
    (questionIndex, optionIndex, survey = newSurvey) => {
      const updatedQuestions = [...survey.questions];
  ...
  const ViewSurveyModal = useCallback(
    ({ survey, onClose }) => {
              ...
              <div className="survey-info">
                ...
                <div className="survey-meta">
                  <select
                    ...
                    value={surveyStatus}
                    onChange={(e) =>
                      handleStatusChange(survey.id, e.target.value)
                    }
                  >
                      ...
                      <div className="question-content">
                        ...
                        {question.type === "rating" && (
                          <div className="rating-preview">
                            {Array.from({
                              length: getRatingScale(question.question),
                            }).map((_, num) => (
                              <span key={num} className="rating-star">
                                ★
                              </span>
                            ))}
                          </div>
  ...
  const renderQuestionForm = useCallback(
    (question, index, survey = newSurvey) => (
        ...
        <div className="question-header">
          ...
          <div className="question-text">
            <input
              ...
              value={question.text}
              onChange={(e) =>
                updateQuestion(index, "text", e.target.value, survey)
              }
            />
          </div>
          ...
          <select
            ...
            value={question.type}
            onChange={(e) =>
              updateQuestion(index, "type", e.target.value, survey)
            }
          >
          ...
          <label className="required-toggle">
            <input
              ...
              onChange={(e) =>
                updateQuestion(index, "required", e.target.checked, survey)
              }
            />
            Required
          </label>
            ...
            {question.options.map((option, optionIndex) => (
              <div key={optionIndex} className="option-item">
                <input
                  ...
                  value={option}
                  onChange={(e) =>
                    updateOption(index, optionIndex, e.target.value, survey)
                  }
                />
                <button
  ...
  const TemplatePreviewModal = useCallback(
    ({ template, onClose }) => {
      ...
      <div className="surveys-list">
        ...
        {surveys.length === 0 ? (
          <p className="no-surveys">
            No surveys created yet. Create one to get started!
          </p>
        ) : (
            ...
            {surveys.map((survey) => (
              <div key={survey.id} className="survey-card">
                ...
                <div className="survey-stats">
                  <span>
                    <FaUsers className="icon" /> {survey.respondents || 0}{" "}
                    respondents
                  </span>
                  <span>
